...
const program = new Command()
  .name('periodic-table')
  .description(
    'Project tooling for the periodic-table app: sitemap generation, spectrum conversion, and collection management.',
  );
...
program
  .command('spectrum')
  .description(
    "Convert a RadiaCode/GammaVision spectrum XML export into the collection's spectrum JSON + public XML download",
  )
