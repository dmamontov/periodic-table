...
export const myElements: Record<string, ElementCollection> = {
  ...
  Ra: {
    ...
    spectrum: {
      ...
      note: {
        ru: 'Собственная линия ²²⁶Ra (184 кэВ) и вся цепочка распада.',
        en: "²²⁶Ra's own line (184 keV) plus the full decay chain.",
    ...
    history: [
      {
        ...
        spectrum: {
          ...
          note: {
            ru: 'Видны ²¹²Pb (238,6 кэВ) и ²²⁸Ac (328 кэВ) — реальные продукты цепочки распада ²³²Th.',
            en: '²¹²Pb (238.6 keV) and ²²⁸Ac (328 keV) are visible — real ²³²Th decay-chain products.',
  ...
  U: {
    ...
    spectrum: {
      ...
      note: {
        ru: 'Дублет ²³⁴Th — продукт цепочки ²³⁸U; линия ²³⁵U — отдельный изотоп той же природной руды, не обогащение.',
        en: 'The ²³⁴Th doublet is a ²³⁸U decay-chain product; the ²³⁵U line is a separate isotope from the same natural ore, not enrichment.',
        zh: '²³⁴Th双峰是²³⁸U衰变链产物；²³⁵U谱线来自同一天然矿石中的独立同位素，并非富集所致。',
      },
    },
  },
  Np: {
  ...
  Pu: {
    ...
    spectrum: {
      ...
      note: {
        ru: 'Доминирует ²⁴¹Am — реакторный ²³⁹Pu содержит примесь ²⁴¹Pu, которая за десятилетия распадается в ²⁴¹Am и забивает слабый сигнал самого ²³⁹Pu.',
        en: "²⁴¹Am dominates — reactor-grade ²³⁹Pu contains a ²⁴¹Pu impurity that decays into ²⁴¹Am over decades, swamping ²³⁹Pu's own weak signal.",
        zh: '谱图由²⁴¹Am主导——反应堆级²³⁹Pu含有²⁴¹Pu杂质，数十年间衰变为²⁴¹Am，掩盖了²³⁹Pu本身微弱的信号。',
      },
    },
  },
  Am: {
    ...
    spectrum: {
      ...
      note: {
        ru: 'Собственная линия ²⁴¹Am (60 кэВ) — однозначно.',
        en: "²⁴¹Am's own line (60 keV) — unambiguous.",
        zh: '²⁴¹Am自身特征峰（60 keV）——明确无误。',
      },
    },
  },
};
