...
<template>
  <PillSwitcherGroup :aria-label="messages.theme">
    ...
    >
      <svg v-if="option.value === 'light'" class="theme-switcher__icon" viewBox="0 0 16 16" aria-hidden="true">
      ...
      <svg v-else-if="option.value === 'dark'" class="theme-switcher__icon" viewBox="0 0 16 16" aria-hidden="true">
        <path
      ...
      <svg v-else class="theme-switcher__icon" viewBox="0 0 16 16" aria-hidden="true">
