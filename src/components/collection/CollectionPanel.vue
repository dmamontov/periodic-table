...
const historyTimeline: HistoryTimelineItem[] = elements
  .flatMap((el) => {
    ...
    const versions: (ElementCollectionHistoryEntry | ElementCollection)[] = [
      ...(el.collection.history ?? []),
      el.collection,
    ];
        ...
        >
          ...
          <div class="collection-panel__rows">
            <div class="collection-panel__row">
              ...
              <span class="collection-panel__row-value"
                ><span :style="{ color: COLLECTION_COLOR }">{{ stats.elementCounts.collected }}</span
                ><span class="collection-panel__row-value-sep">/</span
                ><span class="collection-panel__row-value-mid">{{ stats.elementCounts.collectible }}</span
                ><span class="collection-panel__row-value-sep">/</span
                ><span class="collection-panel__row-value-total">{{ stats.elementCounts.total }}</span></span
              >
            </div>

            <div class="collection-panel__row">
              <span class="collection-panel__row-label">{{ messages.collectionPanel.statRadioactive }}</span>
              <span class="collection-panel__row-track">
                <span
                  class="collection-panel__row-fill"
                  :style="{
                    width: percentOf(stats.radioactiveCounts.collected, stats.radioactiveCounts.total) + '%',
                ...
                <span
                  class="collection-panel__row-unavailable"
                  :style="{
                    left: percentOf(stats.radioactiveCounts.collectible, stats.radioactiveCounts.total) + '%',
                  }"
                />
              </span>
              <span class="collection-panel__row-value"
                ><span :style="{ color: RADIOACTIVE_COLOR }">{{ stats.radioactiveCounts.collected }}</span
                ><span class="collection-panel__row-value-sep">/</span
                ><span class="collection-panel__row-value-mid">{{ stats.radioactiveCounts.collectible }}</span
                ><span class="collection-panel__row-value-sep">/</span
                ><span class="collection-panel__row-value-total">{{ stats.radioactiveCounts.total }}</span></span
              >
            </div>
            ...
            <div v-for="cat in stats.categoryCounts" :key="cat.id" class="collection-panel__row">
              ...
              <span class="collection-panel__row-value"
                ><span :style="{ color: cat.color }">{{ cat.collected }}</span
                ><span class="collection-panel__row-value-sep">/</span
                ><span class="collection-panel__row-value-mid">{{ cat.collectible }}</span
                ><span class="collection-panel__row-value-sep">/</span
                ><span class="collection-panel__row-value-total">{{ cat.total }}</span></span
              >
            </div>
          </div>
