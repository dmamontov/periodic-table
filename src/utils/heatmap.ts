...
export const HEATMAP_DEFINITIONS: HeatmapDefinition[] = [
  {
    ...
    labelKey: 'atomicMass',
    unitKey: 'gPerMol',
    accent: HEATMAP_ACCENT_COLORS.atomicMass,
  },
  {
    id: 'atomicRadius',
    group: 'atomic',
    labelKey: 'atomicRadius',
    unitKey: 'pm',
    accent: HEATMAP_ACCENT_COLORS.atomicRadius,
  },
  {
    id: 'covalentRadius',
    group: 'atomic',
    labelKey: 'covalentRadius',
    unitKey: 'pm',
    accent: HEATMAP_ACCENT_COLORS.covalentRadius,
  },
  {
    id: 'electronegativity',
    group: 'trends',
    labelKey: 'electronegativity',
    accent: HEATMAP_ACCENT_COLORS.electronegativity,
  },
  {
    id: 'ionizationEnergy',
    group: 'trends',
    labelKey: 'ionizationEnergy',
    unitKey: 'eV',
    accent: HEATMAP_ACCENT_COLORS.ionizationEnergy,
  },
  {
    id: 'electronAffinity',
    group: 'trends',
    labelKey: 'electronAffinity',
    unitKey: 'eV',
    accent: HEATMAP_ACCENT_COLORS.electronAffinity,
  },
  { id: 'density', group: 'physical', labelKey: 'density', unitKey: 'gPerCm3', accent: HEATMAP_ACCENT_COLORS.density },
  {
    id: 'meltingPoint',
    group: 'physical',
    labelKey: 'meltingPoint',
    unitKey: 'celsius',
    accent: HEATMAP_ACCENT_COLORS.meltingPoint,
  },
  {
    id: 'boilingPoint',
    group: 'physical',
    labelKey: 'boilingPoint',
    unitKey: 'celsius',
    accent: HEATMAP_ACCENT_COLORS.boilingPoint,
  },
  ...
  { id: 'lifetime', group: 'nuclear', labelKey: 'lifetime', accent: HEATMAP_ACCENT_COLORS.lifetime, scale: 'log' },
  {
    id: 'earthAbundance',
    group: 'other',
    labelKey: 'earthAbundance',
    accent: HEATMAP_ACCENT_COLORS.earthAbundance,
    scale: 'log',
  },
  {
    id: 'meteoriteAbundance',
    group: 'other',
    labelKey: 'meteoriteAbundance',
    accent: HEATMAP_ACCENT_COLORS.meteoriteAbundance,
    scale: 'log',
  },
  {
    id: 'rarity',
    group: 'other',
    labelKey: 'rarity',
    accent: HEATMAP_ACCENT_COLORS.rarity,
    scale: 'log',
...
function extractGlobalRarityValue(detail: StoredElementDetail | null): number | null {
  ...
  const abundances = [pr.universe, pr.sun, pr.ocean, pr.humanBody, pr.crust, pr.meteorites]
...
const heatmapDatasets = Object.fromEntries(HEATMAP_DEFINITIONS.map((def) => [def.id, buildDataset(def.id)])) as Record<
  HeatmapId,
  HeatmapDataset
>;
...
export function getHeatmapIntensity(id: HeatmapId, number: number): number | null {
  ...
  return valueToIntensity(value, dataset.min, dataset.max, def?.scale ?? 'linear', def?.invertIntensity ?? false);
}
