...
const messages: LocaleMessages = {
  ...
  collectionPanel: {
    ...
    wishlistStatusOrdered: 'Заказано',
    wishlistStatusShipping: 'Доставляется',
    close: 'Закрыть',
  ...
  sidebar: {
    ...
    sections: {
      ...
      grid: 'Кристаллическая решётка',
      gridNumbered: 'Кристаллическая решётка #{{n}}',
    ...
    nfpaReactivity: 'Реакционная способность:',
  ...
  seo: {
    ...
    elementDescription:
      '%name% (%symbol%) — химический элемент №%number% в периодической таблице Менделеева. Атомная масса, электронная конфигурация, физические и химические свойства.',
  },
};
