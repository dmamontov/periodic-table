...
- `physical.manufactureDate` - когда сам образец был изготовлен/произведён, а не когда попал в коллекцию (для этого есть `acquiredDate`) - точность произвольная, какая известна: `"2021"`, `"2021-07"` или `"2021-07-31"`.
