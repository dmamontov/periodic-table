...
- **Коллекция элементов** - состояние образца и контейнер, чистота, вес, изотоп, происхождение (прямой источник / продукт распада с цепочкой из нескольких изотопов), фото, интерактивный гамма-спектр - увеличение по клику, метки изотопных линий, подтверждённые по самому измерению (а не просто взятые из справочника), скачивание исходного XML
...
- **География производства** - интерактивная карта на карточке каждого из 118 элементов, включая синтетические (страна лаборатории/ускорителя, где элемент получен) и промышленные газы (страны-лидеры по производству)
