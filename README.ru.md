...
- **Где добывают/производят** - интерактивная карта на карточке каждого из 118 элементов, включая синтетические (страна лаборатории/ускорителя, где элемент получен) и промышленные газы (страны-лидеры по производству)
...
| Где добывают/производят | отдельный раздел на каждом из 118 элементов - карта стран-производителей и краткое пояснение |
